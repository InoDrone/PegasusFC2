/*
 ...
 Modified 28 December 2013 by Marc Jacquier <mj@inodrone.com>
 */
...
namespace os
{
  ...
  void Print::write(const void *buffer, uint32_t size) {
  ...
  void Print::print(uint8_t b, int base) {
      print((uint64_t)b, base);
  }
  ...
  void Print::println(uint8_t b, int base) {
      print(b, base);
      println();
  }
